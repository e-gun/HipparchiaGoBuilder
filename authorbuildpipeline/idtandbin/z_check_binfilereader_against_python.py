...
def resetbininfo():
	...
	bininfo = {
		'genre': '../fileanddb/in/HipparchiaData/greek/LIST3CLA.BIN',
		'genre_clx': '../fileanddb/in/HipparchiaData/greek/LIST3CLX.BIN',
		'recorded_date': '../fileanddb/in/HipparchiaData/greek/LIST3DAT.BIN',
		'epithet': '../fileanddb/in/HipparchiaData/greek/LIST3EPI.BIN',
		'gender': '../fileanddb/in/HipparchiaData/greek/LIST3FEM.BIN',
		'location': '../fileanddb/in/HipparchiaData/greek/LIST3GEO.BIN',
		'canon': '../fileanddb/in/HipparchiaData/greek/DOCCAN2.TXT'
	}

	genres = buildlabellist(bininfo['genre'])
	# print(genres)
	return
